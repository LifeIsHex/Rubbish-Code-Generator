      ...
      6:
        begin
          ...
          case LMaxDice of
            ...
            101..110:
              AndReg32RandNum32(AMem, $FFFFFFFF);
            111..120:
...
begin
  ...
  begin
    ...
    begin
      ...
      case LDice of
        001..002:
          InsertRandomInstruction(LPB, 1, LSize);
        101..104:
          InsertRandomInstruction(LPB, 2, LSize);
        201..208:
          InsertRandomInstruction(LPB, 3, LSize);
        301..316:
          InsertRandomInstruction(LPB, 4, LSize);
        401..432:
          InsertRandomInstruction(LPB, 5, LSize);
        501..564:
          InsertRandomInstruction(LPB, 6, LSize);
      else
        InsertRandomInstruction(LPB, (LDice + 99) div 100, LSize);
      end;
    end
    else
    begin
...
begin
  Result := OffsetToRVA(SetFilePointer(FHandle, 0, nil, FILE_CURRENT), NewSectionRVA, NewSectionOffset);
end;
